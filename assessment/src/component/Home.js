...
const Home = () => {
    return (
        <>
            <div>
                <div className='w-[70%] h-[600px] p-4 mt-5 ml-5 rounded-lg border border-gray-300 '>
                    <h1 className='font-bold text-2xl'>Music Basics</h1>
                    <img className=' object-cover  h-[550px]  w-[100%] p-5 rounded-[50px]' src={pic} alt='' />
                    <div className="absolute inset-0 flex items-center top-[544px] left-[300px]">
