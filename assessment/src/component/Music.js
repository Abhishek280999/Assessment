    ...
    return (
        <>
         <div className='flex bg-white justify-between mb-5'>
                        ...
                        <div className='mt-12 ml-7 text-lg mr-2 font-semibold'><span className='w-36 h-36 rounded-3xl p-4 bg-black mr-2 text-white'><MusicNoteIcon /></span>Learn the</div>
                    </div>
                ...
                <div key={index}>
                    <div className='p-3'>
                        <div className='flex border border-white chat rounded-3xl '>
                            ...
                            <div className='mt-7 '>
                                <h4 className='font-bold ml-6'>{item.name}
                                    <br />
                                ...
                                <div className="relative pt-1 ml-6">
                                    <div className="overflow-hidden h-2 mb-1 text-xs flex rounded w-[350px] bg-gray-200">
                                        <div style={{ width: "70%" }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-gray-400"></div>
                                    </div>
